...
const LandingPage = () => {
  return (
    <div className="bg-gray-100 ">
      ...
      {/* Logo Placeholder moved to the left */}
      ...
      {/* Tagline moved further left */}
      <p className="text-lg text-gray-300 whitespace-nowrap ml-25">Get a free quote and start saving now</p>
    </header>
      ...
      <main className="container  ">
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 text-center md:text-left">
            <h2 className="text-4xl mb-6 font-extrabold text-yellow-400 leading-snug">
              Providing the Highest Standard Care
            </h2>
            <p className="text-lg text-yellow-350 leading-relaxed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero.
            </p>
          </div>

          {/* Right Content */}
          <div className="w-full md:w-1/3 bg-red-700 bg-opacity-90 p-6 rounded-lg shadow-lg max-w-sm mx-auto md:mx-0">
      ...
      <form className="space-y-4">
        <div className="flex space-x-2">
          <input
            ...
            className="w-1/2 p-3 border rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-white"
          />
          <input
            type="text"
        ...
        <input
          ...
          className="w-full p-3 border rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-white"
        />
        <input
          type="text"
        ...
        <button
          type="submit"
          className="bg-blue-700 text-white py-3 px-4 w-full rounded-md hover:bg-blue-800 transition font-bold"
        >
          GET A QUOTE
        </button>
      </form>
  ...
  <div className="w-full md:w-2/3 p-0 flex flex-row md:flex-row items-center mx-auto">
    <img
      src="img2.webp"
      alt="Family Picnic"
      className="w-full md:w-1/2 h-95"
    />
  ...
  <div className="w-full md:w-2/3 p-0 flex flex-col md:flex-row items-center mx-auto">
    ...
    <img
      src="img3.webp"
      alt="Family Picnic"
      className="w-full md:w-1/2 h-75"
    />
  </div>
</section>
